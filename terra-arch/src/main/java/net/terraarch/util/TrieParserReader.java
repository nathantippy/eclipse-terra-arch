...
import net.terraarch.pipe.RawDataSchema;
import net.terraarch.struct.ByteSequenceValidator;
import net.terraarch.struct.DecimalValidator;
import net.terraarch.struct.LongValidator;
